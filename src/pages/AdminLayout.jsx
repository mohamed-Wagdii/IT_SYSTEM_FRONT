...
const menuItems = [
  { name: "Knowledge Base", icon: "bi-book-fill",              path: "/admin" },
  { name: "Tickets",        icon: "bi-ticket-perforated-fill", path: "/admin/tickets" },
  { name: "Asset Manager",  icon: "bi-display-fill",           path: "/admin/assets" },
...
export default function AdminLayout() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ marginLeft: 240, flex: 1, overflowY: "auto", background: "#f9fafb" }}>
        <Outlet />
      </div>
    </div>
  );
